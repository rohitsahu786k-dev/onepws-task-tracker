...
const TaskDependencySelector = ({ title, children, className = '', ...props }) => (
  <div className={`rounded-lg border border-slate-200 bg-white p-4 shadow-sm ${className}`} {...props}>
    ...
    {children || <span className="text-sm text-slate-500">TaskDependencySelector</span>}
  </div>
);

export { TaskDependencySelector };
