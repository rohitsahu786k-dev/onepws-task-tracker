...
export const getAll = taskTimerApi.list;
export const getById = taskTimerApi.get;
export const create = taskTimerApi.create;
export const update = taskTimerApi.update;
export const remove = taskTimerApi.remove;
export default taskTimerApi;
